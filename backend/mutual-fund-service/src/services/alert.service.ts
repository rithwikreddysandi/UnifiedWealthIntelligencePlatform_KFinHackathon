...
export const createFailedSipAlert =
  async (
    investorId: string,
    sipId: string,
    fundName: string,
    ...
    return await alertRepository
      .createAlert({
        ...
        severity:
          AlertSeverity.HIGH,
        message:
          `SIP execution failed for ${fundName}. Reason: ${reason}`,
      });
  };
...
export const createInactiveInvestorAlert =
  async (
    investorId: string,
    inactiveDays: number
  ) => {
    ...
    return await alertRepository
      .createAlert({
        ...
        severity,
        message:
          `Investor inactive for ${inactiveDays} days`,
      });
  };
