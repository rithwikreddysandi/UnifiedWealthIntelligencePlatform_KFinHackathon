...
export const getSipById =
  async (
    ...
    try {
      ...
      const sip =
        await sipService.getSipById(id as string);
...
export const getInvestorSips =
  async (
    ...
    try {
      ...
      return successResponse(
        res,
        "Investor SIPs fetched successfully",
        sips
      );
...
export const deleteSip =
  async (
    ...
    try {
      ...
      const deletedSip =
        await sipService.deleteSip(id as string);
