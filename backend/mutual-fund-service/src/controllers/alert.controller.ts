...
export const getInvestorAlerts = async (
  req: Request,
  res: Response,
  next: NextFunction,
) => {
  try {
    ...
    const alerts = await alertService.getInvestorAlerts(investorId);

    return successResponse(res, "Investor alerts fetched successfully", alerts);
  } catch (error) {
    next(error);
  }
};
...
export const updateAlert = async (
  ...
  try {
    ...
    return successResponse(res, "Alert updated successfully", updatedAlert);
  } catch (error) {
    next(error);
  }
};
...
export const deleteAlert = async (
  ...
  try {
    ...
    return successResponse(res, "Alert deleted successfully", deletedAlert);
  } catch (error) {
    next(error);
  }
};
...
export const getOpenAlerts = async (
  ...
  try {
    ...
    return successResponse(res, "Open alerts fetched successfully", alerts);
  } catch (error) {
    next(error);
  }
};
...
export const getCriticalAlerts = async (
  ...
  try {
    ...
    return successResponse(res, "Critical alerts fetched successfully", alerts);
  } catch (error) {
    next(error);
  }
};
...
export const dismissAlert = async (
  ...
  try {
    ...
    return successResponse(res, "Alert dismissed successfully", alert);
  } catch (error) {
    next(error);
  }
};
