...
export const deleteMandate =
  async (
    ...
    try {
      ...
      const deletedMandate =
        await mandateService
          .deleteMandate(id);

      return successResponse(
        res,
        "Mandate deleted successfully",
        deletedMandate
      );
