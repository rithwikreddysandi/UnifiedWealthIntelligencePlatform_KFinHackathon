...
export const createPropertyValidation = [
  ...
  body("current_valuation").optional().isNumeric(),

  body("ownership_percentage").optional().isNumeric(),
];

export const updatePropertyValidation = [
  body("property_name").optional().isString(),

  body("current_valuation").optional().isNumeric(),

  body("rental_income").optional().isNumeric(),
];
